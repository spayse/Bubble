...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/Bubble"), tr("&About Bubble"), this);
    ...
    toggleHideAction = new QAction(QIcon(":/icons/Bubble"), tr("&Show / Hide"), this);
